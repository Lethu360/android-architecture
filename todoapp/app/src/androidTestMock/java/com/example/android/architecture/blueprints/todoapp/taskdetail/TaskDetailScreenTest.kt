...
class TaskDetailScreenTest {
    ...
    @Rule
    @JvmField
    val mTaskDetailActivityTestRule = ActivityTestRule<TaskDetailActivity>(
            TaskDetailActivity::class.java, true /* Initial touch mode  */,
    ...
    private fun startActivityWithWithStubbedTask(task: Task) {
        ...
        val tasksRepository = Injection.provideTasksRepository(InstrumentationRegistry.getTargetContext())
