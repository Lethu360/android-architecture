...
class StatisticsScreenTest {
    ...
    val mStatisticsActivityTestRule =
            ActivityTestRule<StatisticsActivity>(StatisticsActivity::class.java, true, false)
    ...
    fun intentWithStubbedTaskId() {
        ...
        tasksRepository.saveTask(Task("Title1", "", false))
        tasksRepository.saveTask(Task("Title2", "", true))
